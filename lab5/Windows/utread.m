...
%dat = sig*int32(int32(data_r(1))+int32(data_r(2))*256+int32(data_r(3))*256^2+int32(data_r(4))*256^3);
%speed = sigv*int32(data_r(5))+int32(data_r(6))*256+int32(data_r(7))*256^2+int32(data_r(8))*256^3;
